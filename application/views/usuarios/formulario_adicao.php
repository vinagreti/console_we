...
<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="adicionarUsuarioForm" role="form">
                ...
                <div class="modal-footer">
                    <button id="submitAddUsuario" type="submit" class="btn btn-primary" data-loading-text="Criando...">Criar</button>
