<!-- Modal -->
<div class="modal fade" id="detalharDenunciaModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row denuncia">
                    <div class="col-sm-2">
                        <img id="usuario_avatar" class="img-rounded" style="width:84px">
                    </div>
                    <div class="col-sm-10">
                        <div class="text-info"><strong id="vinculado"></strong></div>
                        <div class="text-muted"><small class="text-warning"><span id="data"></span> - <span id="categoria"></span></small></div>
                        <div id="texto"></div>
                    </div>
                </div>
